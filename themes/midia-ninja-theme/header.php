...
<head>
	...
	<?php wp_head() ?>
	<?php // Anúncios Google desativados — comentado para permitir reativação futura. ?>
	<?php // <script src="https://tpc.googlesyndication.com/sodar/sodar2.js" defer></script> ?>
	<?php // <script src="https://securepubads.g.doubleclick.net/tag/js/gpt.js" defer></script> ?>
	<title><?= is_front_page() ? get_bloginfo('name') : wp_title() ?></title>
	<link rel="icon" href="<?= get_site_icon_url() ?>" />
	<?php // <link rel="preconnect" href="https://securepubads.g.doubleclick.net"> ?>
			...
			<div class="row">
				<div class="col-md-12 header-content">
					<div>
						...
						if (isset($sitepress) && method_exists($sitepress, 'language_url')) {
							$pt_home = $sitepress->language_url($pt_code);
						} else {
							$pt_home = home_url('/');
						}
						?>
						<div class="logo">
							<a href="<?= esc_url($pt_home) ?>">
								<img
